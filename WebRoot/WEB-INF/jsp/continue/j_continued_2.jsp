...
function continue_(i){
    	...
    	var jid = i;
    	window.location.href = "<%=basePath%>continue/jewelleryContinue?jid="+i;
    }
</script>
                          ...
                          <div class="modal-dialog modal-lg  modal-dialog-centered">
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    <button id="btn-`+ i +`" class="btn btn-primary btn-danger" onclick="">续当</button>
                                </div>
                            </div>
                        </div>
                    </div> `;
            if(i%3===0){               //如果位于每一行的最右边 则拥有不同的css样式
                html =`<li data- class="dy-video-item dy-video-meta-left">
                    ...
                    <div class="dy-video-primary">
                        <h4 class="dy-video-title">
                            <a href="#jModal`+ i +`" data-toggle="modal">在线续当</a>
                        </h4>
                    </div>
                </li>`;
                ...
                html =`<li data- class="dy-video-item dy-video-meta-right">
                    ...
                    <div class="dy-video-primary">
                        <h4 class="dy-video-title">
                            <a id="detail" href="#jModal`+ i +`" data-toggle="modal">在线续当</a>
                        </h4>
                    </div>
                </li>`;          
            }
