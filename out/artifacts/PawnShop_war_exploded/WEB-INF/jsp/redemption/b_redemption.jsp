...
<head>
    <meta charset="UTF-8">
    <title>在线赎当-奢侈品箱包</title>
    <link rel="stylesheet" href="css/bootstrap/css/bootstrap.min.css">
    <link rel="stylesheet" href="css/j_continued.css">
</head>
<body>
<!--首页-->
...
<script type="text/javascript">
    function getBagList() {
        $.ajax({
            type:"get",
            url:"<%=basePath%>redemption/getBagList",
            data:{
            	"uid":13
            },
...
function continue_(i){
    	...
    	var id = i;
    	window.location.href = "<%=basePath%>redemption/bagRedemption?bid="+i;
    }
</script>
<script>
