...
<div class="main_box">
    ...
    <div class="main_box_header">
        ...
        <ul class="tab_right">
            ...
            <li style="right: 50px"><a onClick="return confirm('请先登录');" href="<%=basePath%>user/toLogin">个人中心</a></li>
            <li style="right: 0px"><a href="<%=basePath%>login/toLogin">登录</a></li>
        </ul>
    </div>
    <!--轮播图海报-->
...
<!--             <h4>pawnShop</h4> -->
                        ...
                        <li data-index="2">
                            ...
                            <div class="active-inner active-inner-02 clearfix4">
                                <div class="active-inner-item">
                                    ...
                                    <a onClick="return confirm('请先登录');" href="<%=basePath%>login/toLogin" class="btn buy-link-btn">立即典当</a>
                                </div>
                            </div>
                        </li>
                        <li data-index="3">
                            ...
                            <div class="active-inner active-inner-03 clearfix4">
                                <div class="active-inner-item">
                                    ...
                                    <a onClick="return confirm('请先登录');" href="<%=basePath%>login/toLogin" class="btn buy-link-btn">立即续当</a>
                                </div>
                            </div>
                        </li>
                        <li data-index="4">
                            ...
                            <div class="active-inner  active-inner-04 clearfix4">
                                <div class="active-inner-item">
                                    ...
                                    <a onClick="return confirm('请先登录');" href="<%=basePath%>login/toLogin" class="btn buy-link-btn">立即赎当</a>
                                </div>
                            </div>
                        </li>
                        <li data-index="5">
                            ...
                            <div class="active-inner active-inner-05 clearfix4">
                                <div class="active-inner-item">
                                    ...
                                    <a onClick="return confirm('请先登录');" href="<%=basePath%>login/toLogin" class="btn buy-link-btn">立即挂失</a>
                                </div>
                            </div>
                        </li>
                    </ul>
    ...
    <ul class="right_nav">
        <li>
            ...
            <div class="hideBox">
                <div class="hb">
                    <a href="<%=basePath%>login/toLogin"><h5>登录注册</h5></a>
                </div>
            </div>
        </li>
        <li>
